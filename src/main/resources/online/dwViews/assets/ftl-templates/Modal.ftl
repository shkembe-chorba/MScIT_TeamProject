        ...
        <div class="modal-content">
            ...
            <div class="modal-body modal-lg">
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="select1" name="newGameModal-aiPlayers">
                    <label class="custom-control-label" for="select1">1</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="select2" name="newGameModal-aiPlayers">
                    <label class="custom-control-label" for="select2">2</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="select3" name="newGameModal-aiPlayers">
                    <label class="custom-control-label" for="select3">3</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" class="custom-control-input" id="select4" name="newGameModal-aiPlayers">
